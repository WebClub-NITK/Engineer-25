...
export function Carousel({ slides }: CarouselProps) {
  ...
  return (
    <div
      className="relative w-[70vmin] h-[70vmin] mx-auto flex items-center"
      aria-labelledby={`carousel-heading-${id}`}
    >
      <ul
        className="absolute flex mx-[-4vmin] transition-transform duration-1000 ease-in-out items-center justify-center"
        style={{
...
export default function CarouselWithDefault() {
